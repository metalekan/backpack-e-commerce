...
const ProductList = () => {
  ...
  return (
    <div className="w-screen lg:w-full min-h-screen flex justify-center p-4 lg:p-8">
      <div className="flex flex-col md:flex-row bg-white rounded-lg p-4 max-w-2xl mx-auto w-full">
        {/* <AdminMenu /> */}
          ...
          {imageUrl && (
            <div className="text-center">
              <img
                src={imageUrl}
                alt="product"
                className="block mx-auto h-32 w-32 border-4"
              />
            </div>
          )}
